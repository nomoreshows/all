	...
	?>
    <?php // fit = plein écran, cut = tout afficher ?>
    <?php 
    ...
    <div class="padl5">
        ...
        <div class="article">
            ...
            <div id="embed">
            	<?php $embed = '<embed width="590" height="300" flashvars="&amp;vidWidth=590&vidHeight=300&vidPath=http://serieall.fr/videos/'. $article['Article']['video'] . '&thumbPath=http://serieall.fr/img/video.jpg&autoPlay=false&watermark=hide&seekbar=show&autoLoop=false&vidAspectRation=' . $article['Article']['ratio'] . '" wmode="opaque" quality="high" name="playerEmbed" id="playerEmbed" allowfullscreen="true" allowscriptaccess="always" src="http://serieall.fr/swf/playerLite.swf"/>'; ?>
		...
		<?php echo count($article['Comment']); ?> commentaire<?php if (count($article['Comment']) > 1) echo 's'; ?> sur cette vidéo</h2>
    ...
    <div id="col2">
    	...
    	<div id="colright-avis">
            ...
            <div class="colr-content">
                ...
                <tr>
                	<td class="up" width="33%"><?php echo $star->thumb('up'); ?> favorables<br /><?php if (!empty($avis)) echo $commentsup; else echo 0; ?> avis</td>
                    <td class="neutral" width="33%"><?php echo $star->thumb('neutral'); ?> neutres<br /><?php if (!empty($avis)) echo $commentsneutral; else echo 0; ?> avis</td>
                    <td class="down" width="33%"><?php echo $star->thumb('down'); ?> défavorables<br /><?php if (!empty($avis)) echo $commentsdown; else echo 0; ?> avis</td>
                </tr>
                </table>
                <br /> 
                <?php 
