        ...
        <div id="header-center">
            ...
            <tr>
                ...
                <td class="path"><h1><?php echo $html->image('icons/logo.png'); ?> Administration <?php echo $html->image('icons/next.png'); ?> <?php echo $title_for_layout; ?></h1>
                	<br />
            		<span class="notes">Connecté en tant que <strong class="green"><?php echo $name; ?></strong>.</span></td>
           		</tr>
            </table>
            <div id="path">
            </div>
            <div id="menu">
                <ul>
                    ...
                    <li><a href="/securcom/admin/"><?php echo $html->image('menu/accueil.png', array('class' => 'absmiddle')); ?> &nbsp;Accueil</a></li>
                    
                    <?php if ($admin) { ?>
                    <li><a href="/securcom/admin/metiers"><?php echo $html->image('menu/metiers.png', array('class' => 'absmiddle')); ?> Métiers</a></li>
                    <li><a href="/securcom/admin/users"><?php echo $html->image('menu/users.png', array('class' => 'absmiddle')); ?> Utilisateurs</a></li>
                    ...
                    <li><a href="#"><?php echo $html->image('menu/reglages.png', array('class' => 'absmiddle')); ?> Réglages</a></li> -->
                     <?php } ?>
                    <li><a href="/securcom/admin/users/logout"><?php echo $html->image('menu/deco.png', array('class' => 'absmiddle')); ?> Déconnexion</a></li>
                </ul>
            </div>
        </div>
