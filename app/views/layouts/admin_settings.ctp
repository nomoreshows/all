...
<head>
	...
	?>
    	<script src="http://platform.twitter.com/anywhere.js?id=zm9palE7movqr6X6tVTlw&v=1" type="text/javascript"></script>
        ...
        <div id="header-center">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><?php echo $html->link($html->image("menu/comment.png", array("class" => "absmiddle")) .' Slogans', '/admin/slogans/index', array('escape' => false)); ?></li>
                	<li><?php echo $html->link($html->image("menu/comment.png", array("class" => "absmiddle")) .' Twitter', '/admin/users/twitter', array('escape' => false)); ?></li>
                </ul>
            </div>
        </div>
