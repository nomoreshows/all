...
<div id="col1">
    ...
    <div class="article">
    	...
    	<h2 class="red">Avant-Propos</h2>
    	<p>
    		L'utilisation du site et des services Série-All suppose la lecture préalable des présentes Conditions Générales d'Utilisation (CGU).
    		Ces conditions définissent la façon dont les Visiteurs et les Utilisateurs du Service peuvent y accéder et l'utiliser.
    	</p>
    	<p>
    		...
    		La navigation sur le site et l'utilisation des services proposés par Série-All vaut pour acceptation des CGU. 
    	</p>
    	<p>
    		Série-All se réserve le droit de modifier à n'importe quel moment les présentes Conditions, nottament pour prendre en compte des
    		évolutions léagles ou techniques. Les conditions générales d'utilisation en vigeur sont celles disponibles sur le site à la date d'accès 
    		du Visiteur ou Utilisateur.
    	</p>
    	
	<h2 class="red">Accès au site</h2>
	
	<p>
		Le site et les services Série-All sont proposés gratuitement à tout Utilisateur disposant d'un accès internet. 
		Les coûts liés à l'accès au site et aux services Série-All sont entièrement à la charge de l'Utilisateur. 
	</p>
	
	<p>
		La visualisation des articles, des fiches séries ou encore du planning est possible pour tout Utilisateur. 
		Certaines fonctions comme la dépose de notes, d'avis ou de commentaires sont soumis à l'inscription de l'Utilisateur
		au site et services Série-All. L'Utilisateur devient alors un Membre du site.
	</p>
		...
		<br /><br />
		<p>
		En créant un compte sur Série-All, vous vous engagez à utiliser le service tel que prévu et à ne pas 
		essayer d'altérer le site ou de l'utiliser à des fins non prévues initialement. 		
		</p>
		<p>
		...
		<p>
		Les cookies sont de petits fichiers déposés sur votre ordinateur lors de la consultation d'un site web. 
		Ils permettent de collecter des informations afin de vous proposer des services personnalisés. Ces cookies sont
		gérés par votre navigateur de façon transparente, sans que vous ayez à faire quoi que ce soit. 
		...
		Sur serieall.fr, nous utilisons deux types de cookies :
			<ul>
				<li> Les cookies dit "de fonctionnement" : ce sont des cookies qui permettent le bon fonctionnement du site. 
				Par exemple, ce sont ces cookies qui vous permettent de ne pas avoir à vous reconnecter à chaque fois que
