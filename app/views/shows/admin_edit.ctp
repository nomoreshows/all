<table class="toolbar">
	<tr>
    	<td><h1>Modifier une série</h1></td>
	...
	echo $form->input('nationalite', array('label' => 'Nationalité :', 'options' => array('Américaine' => 'Américaine','Anglaise' => 'Anglaise', 'Chinoise' => 'Chinoise' ,'Française' => 'Française','Canadienne' => 'Canadienne','Coréenne'=>'Coréenne','Belge' => 'Belge','Espagnole' => 'Espagnole','Allemande' => 'Allemande','Italienne' => 'Italienne', 'Japonaise' => 'Japonaise', 'Danoise' => 'Danoise', 'Australienne' => 'Australienne', 'Norvégienne' => 'Norvégienne', 'Suédoise' => 'Suédoise', 'Brésilienne' => 'Brésilienne','Mexicaine' => 'Mexicaine' )));

	
	echo $form->input('annee', array('label' => 'Année création :', 'size' => '4'));
	
	echo $form->input('createurs', array('label' => 'Créateurs :<br /><span class="notes">(séparés par virgule)</span>'));
	echo $form->input('realisateurs', array('label' => 'Réalisateurs :<br /><span class="notes">(séparés par virgule)</span>'));
	echo $form->input('scenaristes', array('label' => 'Scénaristes :<br /><span class="notes">(séparés par virgule)</span>'));
	
	echo $form->input('chaineus', array('label' => 'Chaîne VO :', 'size' => '10'));
	echo $form->input('diffusionus', array('label' => 'Première diffusion VO :', 'dateFormat' => 'DMY', 'minYear' => date('Y') - 70, 'maxYear' => date('Y') + 2 ));
	
	echo $form->input('chainefr', array('label' => 'Chaîne VF :', 'size' => '10'));
	echo $form->input('diffusionfr', array('label' => 'Première diffusion VF :', 'dateFormat' => 'DMY', 'minYear' => date('Y') - 70, 'maxYear' => date('Y') + 2 ));
	
	echo $form->input('particularite', array('label' => 'Particularité :<br /><span class="notes">(facultatif)</span>'));
	...
	echo $form->input('is_rentree2017', array('label' => 'Rentrée 2017 :'));
