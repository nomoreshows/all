 ...
 */
	...
	Router::connect('/podcast', array('controller' => 'articles', 'action' => 'liste', 'podcasts'));
	...
	Router::connect('/awards-2016', array('controller' => 'polls', 'action' => 'awards2016'));
	...
	Router::connect('/nouvelles-series-2018-2019', http_redirect('/article/les-series-de-la-rentree-2018_a3976.html'));
