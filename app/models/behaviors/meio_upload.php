	...
	var $default_options = array(
		...
		'validations' => array(
			'FieldName' => array(
				...
				'check' => true,
				'message' => 'Champ non défini (fieldname).'
			),
			'Dir' => array(
				'rule' => array('uploadCheckDir'),
				'check' => true,
				'message' => 'Le dossier d\écriture n\'existe pas ou n\'a pas les droits nécéssaires.'
			),
			'Empty' => array(
			...
			'UploadError' => array(
				...
				'check' => true,
				'message' => 'Problème d\'upload du fichier.'
			),
			'MaxSize' => array(
				'rule' => array('uploadCheckMaxSize'),
				'check' => true,
				'message' => 'Taille du fichier trop grosse.'
			),
			'InvalidMime' => array(
